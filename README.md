...
:warning: We found issues when concurrently serializing Scala Options (see issue #237). Until we can provide a fix we advice against upgrading to 2.0.0 for the time being.
