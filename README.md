...
* v0.4.0 is build against Akka-2.4 and is available for Scala-2.11 and will be made
...
Another useful trick is to provide your own custom initializer for Kryo (see below) and
inside it you register classes of a few objects that are typically used by your application, for example:
...
just any class with a default no-arg constructor and a method called `customize`, which takes one parameter of type Kryo and has a void return type, i.e.
